...
html.A(html.H1(children=['Logout'],
        ...
        ],style={'display': 'inline-block','margin-left':50,'margin-top':10,'margin-bottom':5,'color':'black',"font-size": "0.8em","font-family": "Comic Sans MS"}),
    html.Div(className='row',children=[
    ...
    html.Div(className='row five columns',children=[
               ...
               value=6
                        ...
                        interval=60 * 60000,  # in milliseconds
                        n_intervals=0
                    ),dcc.Interval(
                        id='interval-component2',
                        interval=60 * 60000+10000,  # in milliseconds
                        n_intervals=0
                    )
