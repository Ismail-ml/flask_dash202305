...
a=[['Data Traffic','Data Traffic, TB'],['Call Setup Time','Call Setup time, sec'],['Paging SR','CS Paging SR, %'],['Attach SR','Attach SR, %'],
   ['Location Update SR','Location Update SR, %'],['PDP_Ctx and Bearer Setup SR','PDP Ctx. and Bearer activation SR, %'],
   ['SRVCC Handover SR','VoLTE SRVCC Handover SR, %'],['Initial Registration','VoLTE Initial Registration SR, %'],
   ['VoLTE Call Setup time','VoLTE to VoLTE Call Setup time, sec']]
b=[]
for text in a:
                    ...
                    dcc.RadioItems(id='radio-items2',
                                  ...
                                  value='3D', labelStyle={'display': 'inline-block','margin-left':5,'margin-right':5},
                                   style={'display': 'inline-block','margin-left':50,'margin-top':10,'margin-bottom':5,'background-color':'#CAC7C7',
                                       ...
                                       html.A(html.Button('Reset Graphs',
