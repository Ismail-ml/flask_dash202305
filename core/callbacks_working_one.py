...
yesterday = datetime.date.today() - datetime.timedelta(90)
...
def prepare_data():
    ...
    df_cst = df_cst.merge(df, on='Date')
    ...
    df_traf['Total data traffic, TB'] = df_traf['Total data traffic, MB'] / 1024 / 1024
