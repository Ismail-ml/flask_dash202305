...
def run(path1,path2,tracker):
    ...
    def proccess_excel(diddd):
        ...
        for filename in all_files:
            ...
            df['volte_dl_ps_traf'] = df['1526726776']/8/1024/1024
            df['volte_ul_ps_traf'] = df['1526726803']/8/1024/1024
            df['volte_cs_traf'] = df['1526735162']*0.1/60
    ...
    #           format='table',data_columns=['Date','Vendor','Region'],complevel=5,
    #                min_itemsize={'Vendor':10,'Region':15})
    hw_rnc[['Date','Vendor','Region','volte_sr_num', 'volte_sr_den', 'volte_dr_num', 'volte_dr_den', 'volte_dl_ps_traf',
                          'volte_ul_ps_traf', 'volte_cs_traf']].to_hdf(r'/disk2/support_files/archive/combined_bsc.h5', '/fourGn',
                                                      append=True,
                                                      format='table', data_columns=['Date', 'Vendor', 'Region'],
                                                      complevel=5,
                                                      min_itemsize={'Vendor': 10, 'Region': 15})
    hw_rnc.drop(columns=['volte_sr_num','volte_sr_den','volte_dr_num','volte_dr_den','volte_dl_ps_traf','volte_ul_ps_traf','volte_cs_traf','rtwp']).to_hdf(r'/disk2/support_files/archive/combined_bsc.h5', '/fourG',append=True,
                      format='table', data_columns=['Date', 'Vendor', 'Region'], complevel=5,
                      min_itemsize={'Vendor': 10, 'Region': 15})
